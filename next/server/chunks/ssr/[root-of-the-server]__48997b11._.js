...
async function createNewsArticle(values) {
    ...
    try {
        const fileContent = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].readFile(newsFilePath, 'utf-8');
        ...
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(newsFilePath, JSON.stringify(data, null, 2));
        ...
        return {
            success: false,
            message: 'Failed to write to news file.'
        };
    }
}
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__48997b11._.js.map