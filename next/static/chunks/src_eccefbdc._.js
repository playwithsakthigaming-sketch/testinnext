...
"[project]/src/components/app/upcoming-events.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function UpcomingEvents({ initialEvents }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UpcomingEvents.useEffect": ()=>{
            const syncAndFetchEvents = {
                "UpcomingEvents.useEffect.syncAndFetchEvents": async ()=>{
                    setIsLoading(true);
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$events$2f$data$3a$7c5466__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["syncEventsFromTruckersMP"])();
                    const freshEvents = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$events$2f$data$3a$f43255__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getEvents"])();
                    setEvents(freshEvents);
                    setIsLoading(false);
                }
            }["UpcomingEvents.useEffect.syncAndFetchEvents"];
            syncAndFetchEvents();
        }
    }["UpcomingEvents.useEffect"], []);
    const now = new Date();
    const upcomingEvents = events.map((event)=>({
            ...event,
            parsedDate: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseEventDate"])(event.meetupTime || event.date)
        ...
        const image = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$placeholder$2d$images$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PlaceHolderImages"].find((img)=>img.id === event.imageId);
        return {
            ...event,
            image
        };
...
_s(UpcomingEvents, "bJrrBT6VtyQFMS7tAeOh0YEt81U=");
_c = UpcomingEvents;
var _c;
...
//# sourceMappingURL=src_eccefbdc._.js.map