...
function UpcomingEvents({ initialEvents }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UpcomingEvents.useEffect": ()=>{
            const fetchEvents = {
                "UpcomingEvents.useEffect.fetchEvents": async ()=>{
                    setIsLoading(true);
            ...
            }["UpcomingEvents.useEffect.fetchEvents"];
            fetchEvents();
            const interval = setInterval(fetchEvents, 30000); // Refresh every 30 seconds
            return ({
                "UpcomingEvents.useEffect": ()=>clearInterval(interval)
            })["UpcomingEvents.useEffect"];
        }
    }["UpcomingEvents.useEffect"], []);
    const now = new Date();
...
//# sourceMappingURL=src_3947c7d3._.js.map