...
"[project]/src/app/admin/applications/data:428376 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$applications$2f$data$3a$428376__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/admin/applications/data:428376 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function DeleteApplicationDialog({ applicationId }) {
    ...
    const handleDelete = async ()=>{
        setIsDeleting(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$applications$2f$data$3a$428376__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteApplication"])(applicationId);
        setIsDeleting(false);
        if (result.success) {
            toast({
                title: 'Success',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__443d3d40._.js.map