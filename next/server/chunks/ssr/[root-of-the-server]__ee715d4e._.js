...
function Home() {
    ...
    const upcomingEvents = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$events$2e$json__$28$json$29$__["default"].events.map((event)=>({
            ...event,
            parsedDate: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseEventDate"])(event.meetupTime || event.date)
        })).filter((event)=>event.parsedDate && event.parsedDate > now).sort((a, b)=>a.parsedDate.getTime() - b.parsedDate.getTime()) // Oldest first
    .slice(0, 3).map((event)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ee715d4e._.js.map