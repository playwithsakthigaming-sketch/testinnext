...
function SettingsPage() {
    ...
    const profileForm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
        ...
        defaultValues: {
            "SettingsPage.useForm[profileForm]": async ()=>{
                try {
                    const res = await fetch(`/api/truckershub?endpoint=user`);
                    if (!res.ok) throw new Error(`Failed to fetch user data`);
                    const data = await res.json();
        ...
        }["SettingsPage.useForm[profileForm]"]
    });
...
_s(SettingsPage, "wGmQA1HUFvucKuGz3mchZ1TQhE4=", false, function() {
    return [
...
//# sourceMappingURL=_9bb2f35b._.js.map