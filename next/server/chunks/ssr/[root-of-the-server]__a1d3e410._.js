...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"00d082cd01067ea487fde784b0c7d7ec19a86753ab":"getDashboardData"},"",""] */ __turbopack_context__.s({
...
;
;
async function fetchTruckersHubAPI(endpoint) {
...
async function getDashboardData() {
    try {
        const [statsData, allTime, monthly, jobs, user] = await Promise.all([
            fetchTruckersHubAPI('vtc'),
            fetchTruckersHubAPI('leaderboard/alltime'),
            fetchTruckersHubAPI('leaderboard/monthly'),
            fetchTruckersHubAPI('jobs/all'),
            fetchTruckersHubAPI('user')
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a1d3e410._.js.map