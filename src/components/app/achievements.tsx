...
export function Achievements({ totalDrivers, completedEvents }: AchievementsProps) {
  const achievements = [
    { icon: <Users size={40} />, value: `${totalDrivers}+`, label: "Active Drivers" },
    { icon: <CalendarCheck size={40} />, value: `${completedEvents}+`, label: "Events Completed" },
  ];
