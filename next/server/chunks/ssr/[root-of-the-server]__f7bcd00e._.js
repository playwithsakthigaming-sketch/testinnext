...
"[project]/src/app/admin/applications/data:b9d25d [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/admin/applications/data:a257a8 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$applications$2f$data$3a$b9d25d__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/admin/applications/data:b9d25d [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$applications$2f$data$3a$a257a8__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/admin/applications/data:a257a8 [app-ssr] (ecmascript) <text/javascript>");
...
function UpdateApplicationStatus({ applicationId, status, currentStatus }) {
    ...
    const handleUpdate = ()=>{
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$applications$2f$data$3a$b9d25d__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateApplicationStatus"])(applicationId, status, 'Trainee');
            if (result.success) {
                toast({
                    title: 'Success',
...
function UpdateBookingStatus({ eventId, areaId, bookingId, newStatus }) {
    ...
    const handleUpdate = ()=>{
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$applications$2f$data$3a$a257a8__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateBookingStatus"])(eventId, areaId, bookingId, newStatus);
            if (result.success) {
                toast({
                    title: 'Success',
                    description: result.message
...
"[project]/src/app/admin/applications/data:ef4407 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$applications$2f$data$3a$ef4407__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/admin/applications/data:ef4407 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function DeleteApplicationDialog({ applicationId }) {
    ...
    const handleDelete = async ()=>{
        setIsDeleting(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$applications$2f$data$3a$ef4407__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteApplication"])(applicationId);
        setIsDeleting(false);
        if (result.success) {
            toast({
                title: 'Success',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f7bcd00e._.js.map