...
function ProfilePage() {
    ...
    const userStats = [
        ...
        },
        {
            ...
            value: `${user.total_km.toLocaleString()} km`,
        ...
        {
            label: "Longest Job",
            value: `${user.longest_job.toLocaleString()} km`,
    ...
    const truckersMPProfile = `https://truckersmp.com/user/${user.steam_id}`;
    const steamProfile = `https://steamcommunity.com/profiles/${user.steam_id}`;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=src_4456325b._.js.map